...
import { basePluginRuleSet } from './base-plugin-rule-set.ts';
import {
...
function pluginCoverageSuite(pluginName: string, pluginRules: Readonly<Record<string, unknown>> | undefined): void {
